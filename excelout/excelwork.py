...
def get_ip_data():
    ...
    input_weather = input("Enter weather ")
    input_mood= input("Enter mood ")
    d = {"IP": input_ip, "driver": input_driver,"Location": input_location, "Weaher": input_weather, "Mood": input_mood}
    return d
